// System Telemetry & Health Page using shadcn/ui
function HealthPage({ healthData, pingMs, onRefresh, onResetSeed }) {
  return (
    <div className="space-y-6 animate-fade-in max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="p-5">
          <CardDescription className="text-xs font-bold uppercase tracking-wider">Gateway Status</CardDescription>
        ...
        <Card className="p-5">
          <CardDescription className="text-xs font-bold uppercase tracking-wider">Memory Allocation</CardDescription>
        ...
        <Card className="p-5">
          <CardDescription className="text-xs font-bold uppercase tracking-wider">API Roundtrip Latency</CardDescription>
          <div className="text-2xl font-extrabold text-brand-600 dark:text-cyan-400 mt-2 font-mono">
            {pingMs ? `${pingMs}ms` : '1ms'}
          </div>
          <div className="text-xs text-emerald-600 dark:text-emerald-400 mt-2">Local SQLite query bus</div>
        </Card>

        <Card className="p-5">
          <CardDescription className="text-xs font-bold uppercase tracking-wider">Runtime Platform</CardDescription>
