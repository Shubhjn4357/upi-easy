// Staff & Team Management Page using shadcn/ui
function StaffPage({ staffList, invitesList, onOpenInviteStaff, onSelectStaffAction }) {
  return (
              ...
              <TableRow key={member.id}>
                <TableCell className="font-medium text-foreground">
                  <div className="flex items-center gap-3">
                    ...
                    <span>{member.fullName || "Store Staff"}</span>
                  </div>
                </TableCell>
                ...
                <TableCell>
                  <Badge
                    variant={
                      ...
                      member.role === 'CASHIER' ? 'success' : 'outline'
                    }
                ...
                <TableCell className="text-right">
                  <Button
                    variant="outline"
                    size="sm"
                    onClick={() => onSelectStaffAction(member)}
