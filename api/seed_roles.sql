...
INSERT OR IGNORE INTO permissions (id, name, description, category) VALUES
  ...
  ('perm_tx_delete', 'transactions.delete', 'Delete transactions', 'transactions'),
...
INSERT OR IGNORE INTO role_permissions (id, role_id, permission_id) VALUES
  ...
  ('role_owner_perm_tx_delete', 'role_owner', 'perm_tx_delete'),
...
INSERT OR IGNORE INTO role_permissions (id, role_id, permission_id) VALUES
  ...
  ('role_manager_perm_tx_refund', 'role_manager', 'perm_tx_refund'),
  ('role_manager_perm_tx_delete', 'role_manager', 'perm_tx_delete'),
