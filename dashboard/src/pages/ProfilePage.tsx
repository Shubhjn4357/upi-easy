...
// Business Profile & Organization Settings Page using shadcn/ui with strict TypeScript types
export function ProfilePage({ activeOrg, onSaveProfile }: ProfilePageProps) {
  return (
